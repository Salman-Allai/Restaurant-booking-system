...
const s = {
  page: {
    ...
    padding: 'clamp(80px, 12vw, 100px) clamp(1rem, 4vw, 2rem) 4rem',
  ...
  emptyIcon: {
    color: 'rgba(201,168,76,0.3)', fontSize: '3rem',
  ...
  dateMon: {
    display: 'block', fontSize: '0.65rem', color: '#6b7a9e',
  ...
  detail: { color: '#6b7a9e', fontSize: '0.88rem', lineHeight: '1.5' },
  request: {
    color: '#6b7a9e', fontSize: '0.84rem',
