...
const s = {
  ...
  heroOverlay: {
    position: 'absolute', inset: 0,
    background: 'linear-gradient(105deg, rgba(10,15,30,0.92) 0%, rgba(10,15,30,0.75) 50%, rgba(10,15,30,0.4) 100%)',
  },
  ...
  features: { padding: '6rem 4rem', maxWidth: '1200px', margin: '0 auto' },
  ...
  ctaSection: { padding: '0 4rem 6rem' },

  ctaCard: {
    background: 'rgba(201,168,76,0.05)',
    border: '1px solid rgba(201,168,76,0.2)',
    borderRadius: '24px', padding: '4rem',
